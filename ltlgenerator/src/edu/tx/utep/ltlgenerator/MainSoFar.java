...
public class MainSoFar {
	...
	public static void main(String[] args) {
		...
		System.out.println("ParallelH: " + cpGenerator.getCompositeProposition("Q_ParallelH_5"));
		...
		System.out.println("EventualH: " + cpGenerator.getCompositeProposition("R_EventualH_4"));
		System.out.println("EventualE: " + cpGenerator.getCompositeProposition("Q_EventualE_5"));
	}
