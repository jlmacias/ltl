...
public abstract class LTLGeneratorFactory {
	...
	public static LTLGeneratorFactory getLTLGeneratorFactory(LTLScopeType ltlScopeType) throws LTLScopeTypeNotFoundException {
		...
		default:
			throw new LTLScopeTypeNotFoundException(ltlScopeType.toString());
		}
	}
